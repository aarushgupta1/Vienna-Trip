...
// client-side for immediate feedback (TicketUploadField, CreateModal,
// EditModal) and again server-side (actions.ts, tickets.ts) as a defensive
// backstop, so a single large file can't silently eat into Supabase
// Storage's quota.
