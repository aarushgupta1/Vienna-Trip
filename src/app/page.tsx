...
export default async function HomePage() {
  ...
  return (
    <main className="h-dvh flex flex-col bg-gray-50 dark:bg-gray-950">
      <header className="h-14 bg-gradient-to-r from-blue-50 via-white to-white dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 border-b border-blue-100 dark:border-gray-800 flex items-center justify-between gap-2 px-3 sm:px-5 shrink-0 shadow-sm">
